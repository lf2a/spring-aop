...
public class AopExpressions {
    @Pointcut("execution(* com.lf2a.aroundhandleexception.dao.*.*(..))")
    ...
    @Pointcut("execution(* com.lf2a.aroundhandleexception.dao.*.get*(..))")
    public void getter() {
    }

    @Pointcut("execution(* com.lf2a.aroundhandleexception.dao.*.set*(..))")
    public void setter() {
    }
